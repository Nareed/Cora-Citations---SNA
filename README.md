...
Final project by me and [Shiraz](https://github.com/ShirazFero) for __Social Netowrk Analysis__ course.
...
### 2.1. Data Cleansing
Here we removeed extra columns we didnt need and the final data we built consists of two tables (dataframes):
1. The network
...
__Conclutions__
The edge with highest betweenness is from _Sub category: Compression (Encryption and Compression)_ to 
...
_Build the new netowrk_ Basic infomation about the new network:
Type: DiGraph
Number of nodes: 62
